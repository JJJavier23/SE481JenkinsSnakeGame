...
public class Clock {
	...
	public void setCyclesPerSecond(float cyclesPerSecond) {
		this.setMillisPerCycle((1.0f / cyclesPerSecond) * 1000);
	}
	...
	public void update() {
		...
		if(!isPaused) {
			this.elapsedCycles += (int)Math.floor(delta / getMillisPerCycle());
			this.excessCycles = delta % getMillisPerCycle();
		}
	...
	public void setMillisPerCycle(float millisPerCycle) {
